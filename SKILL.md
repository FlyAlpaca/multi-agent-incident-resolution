...
- Keep each handoff task-specific and apply [subagent-state.md](references/subagent-state.md) as the sole lifecycle authority. Its dispatch, active-task intervention, and terminal-reclamation gates are mandatory and distinct.
